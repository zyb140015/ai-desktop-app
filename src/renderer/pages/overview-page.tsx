      ...
      */}
      <div className="flex flex-col w-full mb-3 shrink-0">
          ...
          <div className="bg-[#10B981] rounded-xl flex justify-between items-center text-white relative overflow-hidden h-[76px] shadow-sm">
              <div className="absolute top-0 right-0 w-[400px] h-full bg-white dark:bg-slate-950/10 skew-x-[30deg] translate-x-20"></div>
              ...
              {[
                ...
                { name: "费用审批", count: 2, icon: "Layers" },
                  ...
                  return (
                  <div key={i} className="flex items-center flex-1 justify-center border-r border-[#34D399]/30 last:border-[#E2E8F0] dark:border-slate-700 h-full relative z-10 cursor-pointer hover:bg-white dark:bg-slate-950/5 transition-colors group">
      ...
      */}
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-3.5 min-h-0">
          ...
          <div className="lg:col-span-2 flex flex-col gap-3.5 h-full min-h-0">
              ...
              <div className="bg-white dark:bg-slate-950 rounded-xl shadow-[0_2px_8px_-4px_rgba(0,0,0,0.05)] p-4 pt-3 flex flex-col shrink-0 relative overflow-hidden">
                  ...
                  <div className="flex items-center mb-1 shrink-0 border-b border-emerald-100/60 pb-1.5 relative z-10">
                      ...
                      <button className="ml-auto text-[12px] text-slate-400 dark:text-slate-500 hover:text-[#10B981] flex items-center">
                  ...
                  <div className="relative z-10">
                    ...
                    {[
                      ...
                      { title: "审批工单-报销团建费用申请", creator: "吴振峰", date: "2024-07-06 14:49:11" },
                        ...
                        <div key={i} className="flex items-center justify-between py-[5px] border-b border-gray-50/70 last:border-[#E2E8F0] dark:border-slate-700 hover:bg-emerald-50/30 -mx-1 px-1 rounded transition-colors group">
              ...
              <div className="bg-white dark:bg-slate-950 rounded-xl shadow-[0_2px_8px_-4px_rgba(0,0,0,0.05)] p-4 pt-3 flex flex-col flex-1 min-h-0">
                  <div className="flex items-center justify-between mb-2 shrink-0 border-b border-gray-50 pb-1.5">
                      <h3 className="text-[14px] font-bold text-slate-800 dark:text-slate-200">我的收藏</h3>
                      <button className="text-[12px] text-slate-400 dark:text-slate-500 hover:text-[#10B981] flex items-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-[1px] mt-0.5">
                        {[
                          ...
                          { name: "2024年全年活动安排.xls", sub: "5.6 MB / 2024-07-08 11:10:56 / 吴晨豪", type: "XLS", color: "bg-[#10B981]" },
                           ...
                           <div key={i} className="flex justify-between items-center group cursor-pointer hover:bg-slate-50 dark:bg-slate-900/80 p-1.5 -mx-1.5 rounded transition-all">
          ...
          <div className="lg:col-span-1 flex flex-col gap-3.5 h-full min-h-0">
              ...
              {/* Quick Actions */}
              <div className="bg-white dark:bg-slate-950 rounded-xl shadow-[0_2px_8px_-4px_rgba(0,0,0,0.05)] p-3 lg:p-4 pt-3 shrink-0">
                  <h3 className="text-[14px] font-bold text-slate-800 dark:text-slate-200 mb-2 bg-gradient-to-r from-[#10B981] to-emerald-400 bg-clip-text text-transparent inline-block">快捷菜单</h3>
                  <div className="grid grid-cols-4 gap-2">
                    {[
                      ...
                      return (
                        <button key={i} className="flex flex-col items-center justify-center p-1.5 rounded-lg hover:bg-slate-50 dark:bg-slate-900 transition-colors group">
                            ...
                            <span className="text-[11.5px] text-slate-600 dark:text-slate-400 group-hover:text-[#10B981] font-medium whitespace-nowrap">{btn.title}</span>
                        </button>
                      );
                    })}
                  </div>
              ...
              {/* Profile Card */}
              <div className="bg-white dark:bg-slate-950 rounded-xl shadow-[0_2px_8px_-4px_rgba(0,0,0,0.05)] p-4 pt-3 flex flex-col shrink-0 min-h-0 relative">
                <div className="flex items-center mb-3 pb-3 border-b border-gray-50 relative cursor-pointer group">
                    ...
                    <div className="ml-3 min-w-0 flex-1 pr-4">
                      <div className="flex items-center">
                         <h2 className="text-[15px] font-bold text-slate-800 dark:text-slate-200 leading-tight truncate">李昭欣</h2>
                         <p className="text-[11px] text-slate-500 dark:text-slate-400 ml-2 truncate">信息化办公室主任</p>
                      </div>
                    </div>
                    <Icons.ChevronDown className="w-3.5 h-3.5 text-slate-300 dark:text-slate-600 absolute right-0 -rotate-90 group-hover:text-[#10B981]" />
                </div>

                <div className="grid grid-cols-2 gap-y-[7px] gap-x-3">
                    <div className="flex flex-col">
                      <span className="text-slate-400 dark:text-slate-500 text-[10.5px] mb-0.5">所属部门</span>
                      <span className="text-slate-700 dark:text-slate-300 text-[11.5px] truncate" title="明镜集团/桃花源分公司/营销部">明镜集团/桃花源分公司...</span>
                    </div>
                    <div className="flex flex-col relative w-full overflow-hidden">
                      <span className="text-slate-400 dark:text-slate-500 text-[10.5px] mb-0.5">用户ID</span>
                      <div className="flex items-center w-full">
                         <span className="text-slate-700 dark:text-slate-300 text-[11.5px] font-mono truncate">25524934542848</span>
                         <Icons.Copy className="w-3 h-3 text-[#10B981] ml-1.5 cursor-pointer flex-shrink-0" />
                      </div>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-slate-400 dark:text-slate-500 text-[10.5px] mb-0.5">账号</span>
                      <span className="text-slate-700 dark:text-slate-300 text-[11.5px] truncate">wangerxiao</span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-slate-400 dark:text-slate-500 text-[10.5px] mb-0.5">职称</span>
                      <span className="text-slate-700 dark:text-slate-300 text-[11.5px] truncate">高级职称</span>
                    </div>
                    <div className="flex flex-col">
                      <span className="text-slate-400 dark:text-slate-500 text-[10.5px] mb-0.5">手机号</span>
                      <span className="text-slate-700 dark:text-slate-300 text-[11.5px] font-mono truncate">123 1234 1234</span>
                    </div>
                    <div className="flex flex-col w-full overflow-hidden">
                      <span className="text-slate-400 dark:text-slate-500 text-[10.5px] mb-0.5">邮箱</span>
                      <span className="text-slate-700 dark:text-slate-300 text-[11.5px] truncate" title="wangerxiao@163.com">wangerxiao@163.com</span>
                    </div>
                </div>
              </div>

              {/* My Schedule (Calendar) */}
              <div className="bg-white dark:bg-slate-950 rounded-xl shadow-[0_2px_8px_-4px_rgba(0,0,0,0.05)] p-4 pt-3 flex flex-col flex-1 min-h-[200px] relative">
                  <div className="flex items-center justify-between mb-1.5 shrink-0">
                      <h3 className="text-[14px] font-bold text-slate-800 dark:text-slate-200">我的日程</h3>
                  </div>
                  
                  {/* Calendar Header */}
                  <div className="flex items-center justify-center mb-1.5">
                      <button className="text-[#10B981] p-0.5"><Icons.ArrowRight className="w-[14px] h-[14px] rotate-180" /></button>
                      <span className="text-[13px] font-medium text-slate-700 dark:text-slate-300 mx-5 text-center w-20">2020年9月</span>
                  ...
                  <div className="flex flex-col text-[12px] h-full w-full">
                    <div className="grid grid-cols-7 text-center shrink-0 mb-1">
                        {['周一', '周二', '周三', '周四', '周五', '周六', '周日'].map(d => <div key={d} className="text-slate-500 dark:text-slate-400 text-[11.5px]">{d}</div>)}
                    </div>
                    <div className="grid grid-cols-7 gap-y-0.5 flex-1 h-full min-h-0">
                        {Array.from({length: 35}).map((_, i) => {
                            ...
                            return (
                              <div key={i} className="flex flex-col items-center justify-center relative py-[2px] cursor-pointer group rounded hover:bg-slate-50 dark:bg-slate-900 transition-colors">
